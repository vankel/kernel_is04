...
struct CameraSensorI2CCmdType {
    ...
    unsigned char   *buf_ptr;           // Pointer to buffer in caller space
    unsigned short  offset;             // Offset in I2C device to read/write
    unsigned short  len;                // Count of bytes to transfer
