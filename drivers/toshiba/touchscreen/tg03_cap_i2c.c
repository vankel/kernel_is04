...
#define SDA_LOW()           gpio_configure(SDA_GPIO, GPIOF_DRIVE_OUTPUT)
#define SDA_HIGH()          gpio_configure(SDA_GPIO, GPIOF_INPUT)

#define SCL_LOW()           gpio_configure(SCL_GPIO, GPIOF_DRIVE_OUTPUT)
#define SCL_HIGH()          gpio_configure(SCL_GPIO, GPIOF_INPUT)

#define SCL_and_SDA_HIGH()  gpio_configure(SCL_GPIO, GPIOF_INPUT);\
                            gpio_configure(SDA_GPIO, GPIOF_INPUT)
